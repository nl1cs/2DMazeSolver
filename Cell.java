    ...
    public void drawType(Graphics g, int scale) {
        ...
        switch (getType()) {
            ...
            case OBSTACLE:
                ...
                break;
            case ICE:
                draw(g, scale, Color.BLUE);
                break;

            case MUD:
                draw(g, scale, new Color(139, 69, 19));
                break;
    ...
    public double getCost() {
        switch (getType()) {
            case FREE:
                return 1.0;
            case OBSTACLE:
                return Double.POSITIVE_INFINITY; // cannot traverse
            case ICE:
                return 0.5; // faster to traverse straight
            case MUD:
                return 2.0; // slower to traverse
            default:
